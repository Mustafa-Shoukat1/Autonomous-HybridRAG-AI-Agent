    ...
    return Assistant(
        ...
        knowledge_base=AssistantKnowledge(
            vector_db=PgVector2(
                ...
                embedder=OpenAIEmbedder(model="text-embedding-3-small",api_key='sk-proj-xT1sMy4bkdlEHOHYUVe9T3BlbkFJvZP8cSGIJgBEtwL4r8VT', dimensions=1536),
            ),
            num_documents=3,
        ),
...
if __name__ == "__main__":
    ...
    llm=OpenAIChat(model=llm_model,api_key='sk-proj-xT1sMy4bkdlEHOHYUVe9T3BlbkFJvZP8cSGIJgBEtwL4r8VT')
